...
<style>
.chart-container { width: 100%; overflow-x: auto; margin: 1.5rem 0; }
.chart-container svg { font-family: Palatino, "Palatino Linotype", "Book Antiqua", Georgia, serif; }
.chart-container .axis text { font-size: 12px; fill: #555; }
.chart-container .axis line, .chart-container .axis path { stroke: #e0e0d8; }
.chart-container .grid line { stroke: #f0f0ea; stroke-dasharray: 2,2; }
.chart-container .grid path { stroke: none; }

figure { margin: 2rem 0 2.5rem; }
figure figcaption { font-size: 0.9rem; color: #777; margin-top: 0.5rem; line-height: 1.5; }

.key-finding { border-left: 3px solid #c23b22; padding: 1rem 1.5rem; margin: 1.5rem 0; background: #faf6f0; }
.key-finding p { margin-bottom: 0.5rem; }
.key-finding p:last-child { margin-bottom: 0; }

table { width: 100%; border-collapse: collapse; margin: 1.5rem 0; font-size: 1.2rem; line-height: 1.8; }
thead th { text-align: left; border-bottom: 2px solid #111; padding: 0.5rem 0.75rem; font-weight: 400; font-variant: small-caps; letter-spacing: 0.05em; }
tbody td { padding: 0.4rem 0.75rem; border-bottom: 1px solid #f0f0ea; }
tbody tr:hover { background: #f8f8f2; }
td.num { text-align: right; font-variant-numeric: tabular-nums; }

.controls { display: flex; gap: 1.5rem; flex-wrap: wrap; margin: 1.5rem 0; padding: 0.8rem 1.2rem; border: 1px solid #e0e0d8; background: #fff; }
.control-group { display: flex; flex-direction: column; gap: 0.15rem; flex: 1; min-width: 140px; }
.control-group label { font-size: 0.65rem; text-transform: uppercase; letter-spacing: 0.06em; color: #777; }
...
.control-group input[type="range"] { width: 100%; accent-color: #c23b22; }
.control-group .range-value { font-size: 0.85rem; font-variant-numeric: tabular-nums; color: #111; font-weight: 600; }
.control-group .helper { font-size: 0.7rem; color: #999; line-height: 1.3; margin-top: 0.15rem; }

.calc-result {
  text-align: center; margin: 1.5rem 0; padding: 1.5rem;
  border: 2px solid #e0e0d8; background: #fff;
}
.calc-result .verdict-number { font-size: 2.8rem; line-height: 1.1; font-variant-numeric: tabular-nums; }
.calc-result .verdict-label { font-size: 0.9rem; color: #777; font-variant: small-caps; letter-spacing: 0.05em; margin-top: 0.3rem; }
.calc-result .verdict-sub { font-size: 0.85rem; color: #999; margin-top: 0.5rem; }
.verdict-positive { color: #2a7d2e; }
.verdict-negative { color: #c23b22; }

.methodology { font-size: 0.85rem; color: #777; line-height: 1.6; }
.methodology a { color: #777; }
...
<script>
const CC = { dark: '#111', gray: '#999', accent: '#c23b22', lightGray: '#e0e0d8', bg: '#f0f0ea' };
let MODEL = null;
